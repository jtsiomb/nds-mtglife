...
#define TEXPAR_FMT_I8		0x10000000
#define TEXPAR_FMT_COMP		0x14000000
#define TEXPAR_FMT_A5I3		0x18000000
#define TEXPAR_FMT_RGB		0x1c000000
#define TEXPAR_KEY0			0x20000000
#define TEXPAR_UV_TEXCOORD	0x40000000
#define TEXPAR_UV_NORMAL	0x80000000
#define TEXPAR_UV_VERTEX	0xc0000000

/* geometry engine status bits */
#define GXSTAT_TEST_BUSY		0x00000001
#define GXSTAT_TEST_RESULT		0x00000002
#define GXSTAT_MVMAT_STACKTOP_MASK		0x00001f00
#define GXSTAT_MVMAT_STACKTOP_SHIFT		8
#define GXSTAT_PROJMAT_STACKTOP_MASK	0x00002000
#define GXSTAT_PROJMAT_STACKTOP_SHIFT	13
#define GXSTAT_MSTACK_BUSY		0x00004000
#define GXSTAT_MSTACK_OVF		0x00008000
#define GXSTAT_FIFO_SIZE_MASK	0x00ff0000
#define GXSTAT_FIFO_SIZE_SHIFT	16
#define GXSTAT_FIFO_FULL		0x01000000
#define GXSTAT_FIFO_LTHF		0x02000000
#define GXSTAT_FIFO_EMPTY		0x04000000
#define GXSTAT_BUSY				0x08000000
#define GXSTAT_CLEAR_FIFO		0x20000000
#define GXSTAT_FIFO_IRQ_LTHF	0x40000000
#define GXSTAT_FIFO_IRQ_EMPTY	0x80000000
